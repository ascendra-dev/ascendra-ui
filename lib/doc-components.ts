...
import { WithLoadingDocContent } from "@/components/previews/with-loading-preview";
import { WithErrorDocContent } from "@/components/previews/with-error-preview";
...
export const docComponents: Partial<Record<string, DocComponent>> = {
  ...
  "with-loading": WithLoadingDocContent,
  "with-error": WithErrorDocContent,
